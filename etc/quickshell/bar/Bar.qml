  ...
  Variants {
    ...
    PanelWindow {
      ...
      Item {
            ...
            Repeater {
              ...
              Rectangle {
                ...
                Text {
                  ...
                  text: wsPill.modelData.id === -99 ? "󱄅" : wsPill.modelData.id
        ...
        // right: now playing, sysinfo, systray
        Row {
          id: rightSection
          ...
          Row {
            ...
            readonly property color batteryColor: {
              if (SysInfo.batteryCharging) return root.theme.accentGreen;
              if (SysInfo.batteryLevelRaw > 20) return root.theme.batteryGood;
              if (SysInfo.batteryLevelRaw > 10) return root.theme.batteryWarning;
            ...
            Rectangle {
              ...
              color: root.theme.bgSurface
              Accessible.role: Accessible.StaticText
              Accessible.name: "CPU: " + SysInfo.cpuUsage
            ...
            Rectangle {
              ...
              Accessible.role: Accessible.StaticText
              Accessible.name: {
                if (SysInfo.networkType === "ethernet") return "Network: Ethernet"
                if (SysInfo.networkType === "wifi") return "Network: WiFi " + SysInfo.networkInfo
              ...
              Row {
                ...
                Text {
                  anchors.verticalCenter: parent.verticalCenter
                  text: {
                    if (SysInfo.networkType === "ethernet") return "󰈀"
                    if (SysInfo.networkType === "wifi") return "󰖩"
                    return "󰖪"
                  }
                  color: SysInfo.networkType === "disconnected" ? root.theme.textMuted : root.theme.accentGreen
                  font.pixelSize: 14
                  font.family: root.font
                }
                Text {
                  anchors.verticalCenter: parent.verticalCenter
                  text: SysInfo.networkInfo
                  color: root.theme.textPrimary
                  font.pixelSize: 11
                  font.family: root.font
                }
            ...
            Rectangle {
              ...
              color: root.theme.bgSurface
              Accessible.role: Accessible.StaticText
              Accessible.name: "Temperature: " + SysInfo.temperature
